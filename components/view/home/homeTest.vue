      ...
      <div class="tools-grid">
        ...
        <div class="tool-card">
          <div class="card-header">
            <h3 class="card-title">Base64 编码/解码工具</h3>
          </div>
        ...
        <div class="tool-card">
          <div class="card-header">
            <h3 class="card-title">URL 编码/解码工具</h3>
          </div>
          <p class="card-description">
        ...
        <div class="tool-card">
          <div class="card-header">
            <h3 class="card-title">JSON 格式化工具</h3>
          </div>
          <p class="card-description">
